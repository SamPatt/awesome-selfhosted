...
- [OpenBazaar](https://www.openbazaar.org/) - Decentralized marketplace for peer to peer trade using cryptocurrencies. ([Source Code](https://github.com/OpenBazaar/openbazaar-go)) `MIT` `Go`
